...
const EmployeeList = () => {
  ...
  return (
    <div className="container mx-auto my-8 flex flex-col justify-center align-center text-center">
    <div>
      <button
      onClick={()=> navigate("/addEmployee")}
       className="bg-slate-600 hover:bg-blue-700 my-10 font-semibold px-20 py-4 rounded"> Add Employee 👨🏼‍💻</button>
    </div>
